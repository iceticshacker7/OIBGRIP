...
public class DomesticTrain extends JFrame
{
	...
	public DomesticTrain(LoginPage type1)
	{
		...
		BFindTrain = new JButton("Find Train");
...
class button3 implements ActionListener
{
	DomesticTrain type;
	LoginPage type1;
	button3(DomesticTrain type, LoginPage type1)
	{
		this.type = type;
		this.type1 = type1;
	}
